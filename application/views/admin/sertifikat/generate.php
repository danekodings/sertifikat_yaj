        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Generate Certifcate</h4>
                  <p class="card-description">

                  <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#staticBackdrop">+ generate</button>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <label class="badge badge-" style="margin-right: 3px;"><a class="text-dark" style="text-decoration: none;" href="<?= base_url('admin/generate/download/' . $generate->assignment_id) ?>">Download</a></label><!-- <label class="badge badge-info" style="margin: 3px;"><a class="text-info" style="text-decoration: none;" href="<?= base_url('edit_generate/' . $generate->assignment_id) ?>">Edit</a></label> --><label class="badge badge-" style="margin-left: 3px;"><a class="text-danger" style="text-decoration: none;" href="<?= base_url('admin/generate/fungsi_hapus/' . $generate->assignment_id) ?>">Delete</a></label></td>
                        </tr>
                        <?php
                        }
                        ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">+ Generate</h1>
              ...
              <div class="modal-body">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="cars" name="certificate_id">
                        <option selected="true" disabled="disabled">Pilih Certificate</option>
                        <?php
                    ...
                    <div class="form-group">
                      <label for="inputAddress2" class="form-label">ID User</label>
                      <select class="form-control" id="cars" name="user_id">
                        <option selected="true" disabled="disabled">Pilih User</option>
                        <?php
                    ...
                    <div class="form-group">
                      <label for="inputAddress2" class="form-label">ID Event </label>
